"""
Database module for logging LiveKit + Groq receptionist calls to Postgres.
"""
...
def init_db():
    ...
    try:
        cur = conn.cursor()
        cur.execute("""
            CREATE TABLE IF NOT EXISTS livekit_groq_call_logs (
...
def log_call(caller_number: str, transcript: str, detected_intent: str, duration: int, summary: str = ""):
    ...
    try:
        ...
        cur.execute(
            """
            INSERT INTO livekit_groq_call_logs
